...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        // require(bytes(tokenIdToStarInfo[_tokenId].name).length == 0, "There is no star for the tokenId.");
        // bytes memory byteString = bytes(tokenIdToStarInfo[_tokenId].name);
        // require(byteString.length > 0, "Length is zero.");
        return tokenIdToStarInfo[_tokenId].name;
    }

    // Implement Task 1 Exchange Stars function
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        // This function swaps tokens between owners and msg.sender must be one of the owners
        ...
        require(msg.sender == owner1 || msg.sender == owner2, "ERC721: transfer not initiated by sender.");

        require(owner1 != owner2,"ERC721: owner owns both tokens.");
